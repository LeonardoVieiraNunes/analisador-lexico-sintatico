...
class AutomataUnion_intersection:
    ...
    def union(self, file1: str, file2: str):
        ...
        self.set_automata(file2, self.base_automata_2)
        self.final_automata = self.union_non_determinized(self.base_automata, self.base_automata_2)
        self.create_epsilon_transitions(self.final_automata)
        self.create_new_intersection_automata(self.final_automata)

    def intersection(self, file1: str, file2: str):
        self.set_automata(file1, self.base_automata)
        self.set_automata(file2, self.base_automata_2)
        self.final_automata = self.union_non_determinized(self.base_automata, self.base_automata_2)
        self.create_epsilon_transitions(self.final_automata)
    ...
    def create_new_union_automata(self, automata, operation):
    ...
    def union_non_determinized(self, afd1: MyOperatingJSON, afd2:MyOperatingJSON):
