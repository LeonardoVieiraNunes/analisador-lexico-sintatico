...
def __init__(self, states=[], initial_state=[], final_state=[], transitions=[], symbols=[]):
    self.data = {
        "states": states,
...
def add_transition(self, state_from: str, state_to: str, transition_symbol: str):
    self.data['transitions'].append({"state_from": "B", "state_to": "A", "transition_symbol": "F"})


def remove_transition(self, state: str):
    self.data['transitions'].remove({"state_from": "B", "state_to": "A", "transition_symbol": "F"})
